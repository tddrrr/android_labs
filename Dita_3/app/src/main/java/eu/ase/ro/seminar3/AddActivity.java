        ...
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validate()) {
                    ...
                    intent.putExtra(STUDENT_KEY, student); //aici se foloseste fie obiect din clasa Serializable fie Parcelable
                    //trimiterea intent-ului catre MainActivity
                    setResult(RESULT_OK, intent); //result ok e un cod standard
